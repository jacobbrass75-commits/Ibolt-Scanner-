...
1. Double-click **Start Inventory.cmd**, or open **https://iboltscan.com** in Chrome or Safari. Sign in with Google or your own email address; if asked for an email code, check your inbox and spam folder. Use this hosted app for all new weights and counts.
